 ...
 * @author dylan
 */
public class alumnoAsigna extends javax.swing.JFrame {

    private Usuario usuario;

    /**
     * Creates new form alumnoAsigna
     */
    public alumnoAsigna(Usuario usuario) {
        initComponents();
        this.usuario = usuario;

        jComboBox1.addItem(this.usuario.getNombre());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Asignacion a Curso");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (usuarioSeleccionado != null && cursoSeleccionado != null) {
            usuarioSeleccionado.cursosU.add(cursoSeleccionado);
