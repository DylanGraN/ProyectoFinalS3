...
public class perfilUsuario extends javax.swing.JFrame {
    ...
    public perfilUsuario(Usuario usuario) {
        ...
        initComponents();
        UsuarioTextField.setText(this.usuario.getUsuario());
        NombreTextField.setText(this.usuario.getNombre());
        ApellidoTextField.setText(this.usuario.getApellido());
        jTextField1.setText(this.usuario.getPassword());
         for (Usuario e : ProyectoFinalS3.usuarios) {

            if (e.getNombre().equals(NombreTextField.getText())) {
    ...
    public void editarAlumno(int posicion) {
